...
To create token HMAC SHA-256 algorithm is used. To understand how to generate client connection token see special chapter [Tokens and signatures](../server/tokens_and_signatures.md).
