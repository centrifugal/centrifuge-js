...
Centrifuge.prototype = {
    ...
    _jsonp: function (url, params, headers, data, callback) {
        if (headers.length > 0) {
    ...
    _ajax: function (url, params, headers, data, callback) {
        var self = this;
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                    ...
                    self._log('Could not get auth info from application', xhr.status);
    ...
    _websocketSupported: function () {
        return !(typeof WebSocket !== 'function' && typeof WebSocket !== 'object')
    },

    _sockjsEndpoint: function () {
    ...
    _rawWebsocketEndpoint: function () {
        var url = this._config.url;
        url = url
            .replace('http://', 'ws://')
            .replace('https://', 'wss://');
    ...
    _resetRetry: function () {
        this._debug('reset retries count to 0');
        this._retries = 0;
    },

    _getRetryInterval: function () {
        var interval = backoff(this._retries, this._config.retry, this._config.maxRetry);
        this._retries += 1;
        return interval;
    },

    _clearConnectedState: function (reconnect) {
        this._clientID = null;
    ...
    _disconnect: function (reason, shouldReconnect) {
    ...
    _publishResponse: function (message) {
        var uid = message.uid;
        var body = message.body;
    ...
    _presenceResponse: function (message) {
        var uid = message.uid;
        var body = message.body;
        if (!(uid in this._callbacks)) {
            return;
    ...
    _historyResponse: function (message) {
        var uid = message.uid;
        var body = message.body;
        if (!(uid in this._callbacks)) {
            return;
    ...
    _joinResponse: function (message) {
        var body = message.body;
        var channel = body.channel;
    ...
    _leaveResponse: function (message) {
        var body = message.body;
        var channel = body.channel;
    ...
    _refreshResponse: function (message) {
        if (this._refreshTimeout) {
            clearTimeout(this._refreshTimeout);
        }
        if (!errorExists(message)) {
    ...
    _recover: function (channel) {
        return channel in this._lastMessageID;
    },

    _getLastID: function (channel) {
    ...
    _createErrorObject: function (err, advice) {
        var errObject = {
            error: err
        };
        if (advice) {
    ...
    _errorObjectFromMessage: function (message) {
        return this._createErrorObject(message.error, message.advice);
    },

    _registerCall: function (uid, callback, errback) {
        var self = this;
        this._callbacks[uid] = {
            callback: callback,
            errback: errback
    ...
    subscribe: function (channel, events) {
        if (arguments.length < 1) {
...
Sub.prototype = {
    ...
    _isUnsubscribed: function () {
        return this._status === _STATE_UNSUBSCRIBED;
    },

    _isSubscribing: function () {
    ...
    _setSubscribeSuccess: function (recovered) {
    ...
    _setSubscribeError: function (err) {
    ...
    _getSubscribeSuccessContext: function () {
        return {
            channel: this.channel,
    ...
    _getSubscribeErrorContext: function () {
